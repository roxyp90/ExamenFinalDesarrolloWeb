        ...
        <div class="container-fluid">
                                ...
                                <div class="col-md-6">
                                    <div class="card card-widget widget-user" style="border-top: 3px solid #D97A26;">
                                        <div class="widget-user-header" style="background-color: #D97A26;">
                                            <h3 class="widget-user-username" style="color: white;">Distribuidora ABC</h3>
                                ...
                                <div class="col-md-6">
                                    <div class="card card-widget widget-user" style="border-top: 3px solid #688B3E;">
                                        <div class="widget-user-header" style="background-color: #688B3E;">
                                            ...
                                            <h5 class="widget-user-desc" style="color: white;">Especialista en Lácteos</h5>
                                        </div>
                                        <div class="widget-user-image">
                                            <img class="img-circle elevation-2"
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card" style="background: white; border-radius: 8px; box-shadow: 0 4px 6px rgba(74, 46, 20, 0.1); border: 1px solid #E8C547;">
                        <div class="card-header" style="background-color: #fafafa; border-bottom: 2px solid #E8C547;">
                            <h3 class="card-title" style="color: #D97A26; font-weight: bold;">Últimas Órdenes de Compra</h3>
                        </div>
                            ...
                            <table class="table table-hover text-nowrap">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>2024-12-15</td>
                                        <td><span class="badge" style="background-color: #688B3E; color: white; padding: 0.4rem 0.8rem; border-radius: 4px;">Entregado</span></td>
                                    </tr>
                                    <tr>
                                        <td>Alimentos XYZ</td>
                                        <td>2024-12-14</td>
                                        <td><span class="badge" style="background-color: #E8C547; color: #4A2E14; padding: 0.4rem 0.8rem; border-radius: 4px;">En tránsito</span></td>
                                    </tr>
                                    <tr>
                                        <td>Distribuidora ABC</td>
                                        <td>2024-12-10</td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content" style="background-color: white; border: 1px solid #E8C547;">
            <div class="modal-header" style="background-color: #fafafa; border-bottom: 2px solid #E8C547;">
                <h5 class="modal-title" id="modalAgregarProveedorLabel" style="color: #D97A26; font-weight: bold;">Agregar Nuevo Proveedor</h5>
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        <label for="nombreProveedor" style="color: #4A2E14; font-weight: 600;">Nombre de la Empresa</label>
                        <input type="text" class="form-control" id="nombreProveedor" placeholder="Ingrese el nombre" style="border: 1px solid #E8C547; border-radius: 4px;">
                    </div>
                    <div class="form-group">
                        <label for="contactoProveedor" style="color: #4A2E14; font-weight: 600;">Persona de Contacto</label>
                        <input type="text" class="form-control" id="contactoProveedor"
                            placeholder="Nombre del contacto" style="border: 1px solid #E8C547; border-radius: 4px;">
                    </div>
                    <div class="form-group">
                        <label for="emailProveedor" style="color: #4A2E14; font-weight: 600;">Email</label>
                        <input type="email" class="form-control" id="emailProveedor" placeholder="Ingrese el email" style="border: 1px solid #E8C547; border-radius: 4px;">
                    </div>
                    <div class="form-group">
                        <label for="telefonoProveedor" style="color: #4A2E14; font-weight: 600;">Teléfono</label>
                        <input type="tel" class="form-control" id="telefonoProveedor" placeholder="Ingrese el teléfono" style="border: 1px solid #E8C547; border-radius: 4px;">
                    </div>
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="direccionProveedor" rows="3"
                            placeholder="Ingrese la dirección" style="border: 1px solid #E8C547; border-radius: 4px;"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="especialidadProveedor" style="color: #4A2E14; font-weight: 600;">Especialidad</label>
                        <select class="form-control" id="especialidadProveedor" style="border: 1px solid #E8C547; border-radius: 4px;">
            ...
            <div class="modal-footer" style="background-color: #fafafa; border-top: 1px solid #E8C547;">
                ...
                <button type="button" class="btn btn-sm" style="background-color: #688B3E; color: white; border: none; border-radius: 4px;">Guardar Proveedor</button>
            </div>
        </div>
    </div>
</div>
