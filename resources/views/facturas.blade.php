        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box" style="background-color: #D97A26; color: white;">
                        <div class="inner">
                            <h3>150</h3>
                        ...
                        <a href="#" class="small-box-footer" style="color: white;">Más info <i
                ...
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box" style="background-color: #688B3E; color: white;">
                        <div class="inner">
                            <h3>$2,500</h3>
                ...
                <div class="col-lg-3 col-6">
                    <!-- small box -->
                    <div class="small-box" style="background-color: #E8C547; color: #4A2E14;">
                        <div class="inner">
                            <h3>53</h3>
                        ...
                        <a href="#" class="small-box-footer" style="color: #4A2E14;">Más info <i
                                class="fas fa-arrow-circle-right"></i></a>
                    </div>
                </div>
                <!-- ./col -->
            ...
            <div class="modal-body">
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <table class="table table-sm" id="productosFactura">
                            <thead>
                                <tr>
                                    <th>Producto</th>
                                    <th>Cantidad</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input type="number" class="form-control form-control-sm" value="1" min="1"
                                            style="border: 1px solid #E8C547; border-radius: 4px;"></td>
                                    <td>$2.50</td>
                                    <td>$2.50</td>
                        ...
                        <button type="button" class="btn btn-sm"
                            ...
                            id="agregarProductoFactura">Agregar Producto</button>
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
...
<script src="{{ asset('backend/dist/js/facturas.js') }}"></script>
@endsection